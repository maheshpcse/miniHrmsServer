...
const valid = { DB_HOST:'mysql.railway.internal', DB_USER:'test', DB_PASSWORD:'test-only', DB_NAME:'mini_hrms', DB_CLIENT:'mysql2', CORS_ORIGINS:'https://example.github.io', PORTAL_SECURITY_KEY:'test-only', TRUST_PROXY:'1' };
