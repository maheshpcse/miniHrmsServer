# mini_hrms data dictionary

MySQL 8.0; 13 application tables, 142 columns. JSON document keys retain their existing case. SQL definitions are in `schema/mini_hrms.sql`; `schema/tables.json` is the migration source.
...
## employee_attendance_saved_details
